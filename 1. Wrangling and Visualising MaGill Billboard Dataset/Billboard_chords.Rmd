...
`pacman, tidyverse, DT, forcats, kableExtra, readr, ggrepel, scales, stringr`

```{r setup, include = FALSE}
  knitr::opts_chunk$set(echo = TRUE)
  library(pacman)
  p_load(tidyverse, DT, forcats, kableExtra, readr, scales, stringr, ggrepel)
```
...
```{r echo = FALSE, warning = FALSE, message = FALSE, fig.align = "center", fig.width = 7.1, fig.asp = 1.11}
 ...
 bb_count_labels$chord <- factor(bb_count_labels$chord,
  ...
  common.chords <- ggplot(bb_count_labels, aes(x = fct_reorder(label, desc(chord)), y = share, fill =   share)) +
                   ...
                   theme(legend.position = "none",
                         ...
                         panel.grid.major.x = element_line(color = "#BABABA", 
                                                          linetype = "dotted"),
...
common_bigrams <- ggplot(bb_bigram_perc, aes(x = reorder(bigram, n), y = share, fill = n)) +
                  ...
                  theme_minimal() +
                  theme(legend.position = "none",
                        axis.text.x = element_text(family = "Source Sans Pro", size = 16, color = "white", face = "bold"),
                        axis.text.y = element_blank(),
                        axis.title.x = element_blank(),#element_text(family = "Source Sans Pro", size = 16, color = "white", face = "bold"),
                ...
                labs(title = "Share of the top 12 most common chord progressions (bigrams)",
                     subtitle = "in the McGill Billboard Dataset", 
                     caption = "Topic: Kris Shaffer, DataCamp project | 
                       Data: McGill Billboard Dataset | ggplot2 chart: M. Blum-Oeste") +
...
chords_instruments <- ggplot(chords_guitar_piano, aes(x = chord, y = n, fill = instrument)) +
                      ...
                      labs(title = "Number of the most common chords in selected guitar and piano songs",
                           subtitle = "McGill Billboard Dataset",
                           caption = "Topic: Kris Shaffer, DataCamp project | 
                                           Data: McGill Billboard Dataset | ggplot2 chart: M. Blum-Oeste")
#View plot
chords_instruments
